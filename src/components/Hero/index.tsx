            ...
            <div className="home-hero__content">
                ...
                <div className="home-hero__info">
                    <p className="text-primary-description">
                        Um desenvolvedor Full Stack Python orientado a resultados, muito motivado, construindo e
                        gerenciando aplicações web e projetos focados na experiência do usuário.
                    </p>
                </div>
                <div className="home-hero__cta">
                    <a href="./#projects" className="button btn--bg">Projetos</a>
                </div>
            </div>
