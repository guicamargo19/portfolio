      ...
      <section className="home-hero" key={project.id}>
        <div className="home-hero__content">
          ...
          <div className="home-hero__info">
            <p className="text-primary-description">{project.description}</p>
          </div>
          ...
          <div className="project-details__content">
            ...
            <div className="project-details__content-main">
              ...
              <div className="project-details__tools-used">
                <h2 className="project-details__content-title">
              ...
              <div className="project-details__links">
                ...
                <a
                  ...
                  className="button btn--med btn--theme project-details__links-btn"
                  target="_blank"
                  rel="noreferrer"
                >
                  Repositório
                ...
                <a
                  ...
                  className="button btn--med btn--theme-inv project-details__links-btn"
                >
                  Voltar
                </a>
              </div>
